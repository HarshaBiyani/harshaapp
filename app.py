...
def happydiwali():
    ...
    try:
        ...
        pass
    return "<body style='background-color:black;'><b style='position:absolute; top:180px; left:220px; color:white; font-size:x-large;'> "+str(name)+"</b><img src='http://i.123g.us/c/eoct_diwali_celebration/card/105182.gif'/></body>"
